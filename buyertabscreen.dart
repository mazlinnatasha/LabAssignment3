...
import 'package:barterit/models/catch.dart';
import 'package:barterit/models/user.dart';
import 'package:http/http.dart' as http;
import 'package:barterit/myconfig.dart';
import 'package:barterit/view/screen/buyercartscreen.dart';
...
class _BuyerTabScreenState extends State<BuyerTabScreen> {
                            ...
                            child: InkWell(
                              ...
                              child: Column(children: [
                                CachedNetworkImage(
                                  ...
                                  fit: BoxFit.cover,
                                  imageUrl:
                                      "${MyConfig().SERVER}/barterit/assets/catches/${catchList[index].catchId}.png",
  ...
  void loadCatches(int i) {
    http.post(Uri.parse("${MyConfig().SERVER}/barterit/php/load_catches.php"),
        body: {
